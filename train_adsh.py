...
parser.add_argument('--exp', type=str, default='adsh')
...
if __name__ == '__main__':
    ...
    adsh_A = ADSH(num_cls=config.num_cls, thresh_major=0.9, tot_iter=len(db_unlabeled)//4)
    adsh_B = ADSH(num_cls=config.num_cls, thresh_major=0.9, tot_iter=len(db_unlabeled)//4) # <--
